...
in {
  options = {
    ...
    namedPackageSingletonDefault =
      lib.mkPackageOption pkgs "Hello" { default = "hello"; };
    ...
    packageWithPathExample =
      lib.mkPackageOption pkgs "hello" { example = [ "hello" ]; };
    ...
    nullablePackageWithDefault =
      lib.mkPackageOption pkgs "hello" { nullable = true; };

    packageWithPkgsText =
      lib.mkPackageOption pkgs "hello" { pkgsText = "myPkgs"; };

    packageFromOtherSet =
      let myPkgs = { hello = pkgs.hello // { pname = "hello-other"; }; };
