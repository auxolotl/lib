...
lib.mapAttrs (lname: lset:
  ...
  in mkLicense lset) ({
    ...
    generaluser = {
      ...
      url =
        "https://www.schristiancollins.com/generaluser.php"; # license included in sources
    };
    ...
    ncul1 = {
      ...
      url =
        "https://raw.githubusercontent.com/netdata/netdata/master/web/gui/v2/LICENSE.md";
    };
    ...
    sustainableUse = {
      ...
      free = false;
      redistributable =
        false; # only free to redistribute "for non-commercial purposes"
    };
